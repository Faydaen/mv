...
var LinkDialog = {
	preInit : function() {
		...
		if (url2 = tinyMCEPopup.getParam("external_link_list_url_2"))
			document.write('<script language="javascript" type="text/javascript" src="' + url2 + '"></script>');
	},
	...
	init : function() {
		...
		this.fillFileList('link_list2', 'tinyMCELinkList2');
