<?php
class boostBaseObject extends Object
{
	public static $METAOBJECT = 'boost';
    public static $ID_METAATTRIBUTE = 'boost.id';
 	public static $ID = 'boost.id';
    public $player = 0;
    public static $PLAYER = 'boost.player';
    public $clan = 0;
    public static $CLAN = 'boost.clan';
    public $fraction = '';
    public $fraction_Dictionary = array('arrived','resident');
    public static $FRACTION = 'boost.fraction';
    public $type = '';
    public static $TYPE = 'boost.type';
    public $code = '';
    public static $CODE = 'boost.code';
    public $value = '';
    public static $VALUE = 'boost.value';
    public $dt = '0000-00-00 00:00:00';
    public static $DT = 'boost.dt';
    public $dt2 = '0000-00-00 00:00:00';
    public static $DT2 = 'boost.dt2';
    public $info = '';
    public static $INFO = 'boost.info';
