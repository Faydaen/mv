...
<body onresize="chatBottomResize();">

<div id="chatSwf"></div>
<div class="chat chat-bottom" id="chat-bottom">
	<div class="chat-cover">
		<div id="chat-headline" class="chat-headline">
			<div class="chat-size-controls">
				<i class="icon chat-size-controls-up" title="Увеличить высоту чата" onclick="chatHeightChange('up')"></i>
				<i class="icon chat-size-controls-down" title="Уменьшить высоту чата" onclick="chatHeightChange('down')"></i>
				<i class="icon reload-icon" title="Обновить страницу" onclick="self.location.reload(true)"></i>
				<i class="icon chat-size-controls-leftside" title="Чат влево" onclick="chatFramesLayout('left');"></i>
						...
						<tr>
							<td>
								<span id="input-private" style="display: none;">
									Кому: <input id="player_to" name="player_to" value="" size="15" type="text" />
								</span>
							</td>
							<td class="text-cell">
