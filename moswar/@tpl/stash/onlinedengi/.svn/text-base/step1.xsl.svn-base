		...
		<div class="column-right-topbg">
			<div class="column-right-bottombg" align="center">
				<div class="heading clear">
					<h2>Шаг 1 / Покупка мёда через ДеньгиОнлайн</h2>
				</div>
				<div id="content" class="stash">
					...
					<form method="POST" action="/stash/onlinedengi/step2/" style="margin-right:150px">
						<table class="forms">
							<tr>
							...
							<tr>
								<td class="label"></td>
								<td class="input">
									<img src="/@/images/stash/onlinedengi.png"  vspace="5" hspace="5" />
									<br clear="all" />
									<p>Сервис OnlineDengi - крупнейший агрегатор игровых платежей в Росcии, непрерывно и динамично развивающийся на рынке оплаты онлайн-проектов и их поддержки.</p>
                                </td>
							</tr>
						</table>
					</form>
